...
function generateRandomNumber() {
  ...
  numberElement.textContent = "CPU Process: " + randomNumber + "%";
}
...
function removeVirus() {
  ...
  const possibleClasses = ['shake-effect', 'invert-effect', 'glitch-effect', 'barrel-roll', 'hue-spin', 'css-less', 'color-downgrade', 'pixelate', 'blurry', 'monochrome', 'unrecognizable'];
...
function glitchEffect() {
  document.getElementById('desktop-wrapper').classList.add('glitch-effect');
}
...
function pixelate() {
  document.getElementById('desktop-wrapper').classList.add('pixelate');
}
